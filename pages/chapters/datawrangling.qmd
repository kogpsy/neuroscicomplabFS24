...
knitr::opts_knit$set(root.dir = '../../data/data_import_single')
```
...
4. Kopieren Sie in den `data`-Ordner Ihre erhobenen Daten des Stroop Experiments. Falls Sie noch keine Daten erhoben haben, dann laden Sie [hier](../../downloadable_files/import-data.zip)  Beispiels-Datensätze herunter. Sie müssen den Ordner entzippen und den Stroop-Datensatz in den `data`-Ordner Ihres Projekts kopieren.
