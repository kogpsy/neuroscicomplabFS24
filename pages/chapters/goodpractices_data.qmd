...
![](img/standards_xkcd.png)
[xkcd Comic](https://imgs.xkcd.com/comics/standards_2x.png)

# Good Practices im Datenmanagement

Im Folgenden wird auf einige wichtige _Good Practices_ in der Datenverarbeitung eingegangen.
...
__Website der [Open Science Foundation](https://osf.io/)__
...
__Brain Imaging Data Structure (BIDS)__
...
_Tipp: Sie können die Tabelle auch ganz simpel in RMarkdown erstellen, wie das funktioniert können Sie [hier](https://quarto.org/docs/authoring/tables.html) nachlesen._
