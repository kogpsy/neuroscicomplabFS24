...
Erstellen Sie einen Plot der Stroop Daten. Verwenden Sie dazu `ggplot()`. Alle Plots und der entsprechende Code werden in der [Galerie](https://kogpsy.github.io/neuroscicomplabFS24/pages/chapters/galery.html) auf der Kurshomepage anonym veröffentlicht.
...
:::{.callout-caution}
## Wichtig
Ihr Plot und der dazugehörige Code wird in der [Galerie](https://kogpsy.github.io/neuroscicomplabFS24/pages/chapters/galery.html) anonym veröffentlich. Deshalb ist es wichtig, dass die oben aufgelisteten Voraussetzungen erfüllt sind. 
:::
