...
Das [Random Dot Kursexperiment](https://github.com/kogpsy/random-dot-experiment) ist folgendermassen aufgebaut:

![](img/exp_rd_flowchart.JPG)
...
[Hier](https://kogpsy.github.io/neuroscicomplabFS24/pages/chapters/uebung_1_experiment.html) finden Sie die Anweisungen dazu.

1. Testen Sie, ob das Experiment startet und ob die Übungstrials funktionieren. Kontrollieren Sie, ob es ein Datenfile abgespeichert hat und schauen Sie, ob dieses Datenfile [alles Relevante](https://kogpsy.github.io/neuroscicomplabFS24/pages/chapters/psychopy_experiments.html#test-pilotierung) enthält. Wenn alles ok ist, ist das Experiment bereit für Übung 1. Führen Sie die Testungen ausserhalb des Computerlabs durch.
