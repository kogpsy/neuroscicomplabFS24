...
Das `working memory` innerhalb eines R Markdown Files ist der Speicherort des Files. Von dort aus können somit _relative_ Pfade angegeben werden. Das hat den Vorteil, dass andere Benutzer denselben Ordner mit unveränderten Pfaden verwenden können. 
