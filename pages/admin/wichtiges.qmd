...
Der Kurs entspricht 5 ETCS, die Leistung setzt sich aus der Anwesenheit im Kurs und dem Erbringen von Leistungsnachweisen zusammen. 

## Anwesenheit

Die Anwesenheit im Kurs wird vorausgesetzt (2 Abwesenheiten sind ok). Wir würden den Kurs gerne ohne Anwesenheitskontrollen durchführen - falls nötig werden wir diese aber einführen.
...
Leistungsnachweise werden in Form von __5 Übungen__ und __2 Quizzes__ erbracht. Hiervon müssen alle abgegeben und als bestanden bewertet werden. Bei Nicht-Bestehen erhalten Sie eine 2. Frist für die Abgabe oder einen Zusatzauftrag. 

Alle Leistungsnachweise werden in den Veranstaltungen angekündigt. Die Termine für die Leistungsnachweise finden Sie [hier](https://kogpsy.github.io/neuroscicomplabFS24/pages/admin/termine.html).
